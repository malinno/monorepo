...
export default function PipeEdge(props: EdgeProps) {
  const {
    id,
    source,
    target,
  ...
  const sFactor = getNodeFlowFactor(sNode as any);
  const tFactor = getNodeFlowFactor(tNode as any);
