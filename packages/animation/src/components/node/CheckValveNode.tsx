...
export default function CheckValveNode({ data }: any) {
    ...
    <div style={{ width: 120, height: 90, position: "relative" }}>
      ...
      >
        ...
        <rect
          ...
          strokeWidth="3"
        />
        <rect x="14" y="30" width="92" height="12" rx="6" fill="#e2e8f0" />
        {/* lá 1 chiều (tam giác) */}
        <path d="M52 22 L72 36 L52 50 Z" fill="#94a3b8" stroke="#334155" />
      </svg>
      <Handle
        id="in"
        type="target"
